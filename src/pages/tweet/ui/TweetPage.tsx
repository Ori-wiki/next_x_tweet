...
import { ThreadReplyTree } from '@/widgets/tweet-feed';
import { Tweet } from '@/widgets/tweet-feed';
import { TweetForm } from '@/features/create-tweet';
import { getSessionUser } from '@/entities/user';
import { getDictionary, resolveLanguage } from '@/shared/lib/i18n';
import { getTweetThread } from '@/entities/tweet';
    ...
    <div className='space-y-6'>
      ...
      {ancestors.length > 0 ? (
        <div className='space-y-3'>
          ...
          <div className='space-y-4 border-l border-(--color-border) pl-4 sm:pl-6'>
